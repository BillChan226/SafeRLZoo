...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
    ...
    demo_path_dir = '/home/gong112/service_backup/work/zhaorun/PSGCL/ppo/demo_jaka.pickle'
    ...
    # input()
    # print(demo_data["obs"][:10])
    demo_data["obs"] = np.array(demo_data["obs"])[:,:6]
    
    print("demo_data", np.shape(demo_data["obs"]))
...
if __name__ == '__main__':
    ...
    for args.seed in range(0, 3):#0,10
        ...
        model, env = ppo(lambda : gym.make(args.env, dubug_mode=False, action_repeat=1), actor_critic=core.MLPActorCritic,
