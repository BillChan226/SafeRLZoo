    ...
    for epoch in range(epochs):
        ...
        for t in range(local_steps_per_epoch):
            ...
            if epoch > 200:
                ...
                if len(demo_act) > 20000:
                    demo = {"obs": demo_obs, "act": demo_act}
                    with open("demo_jaka.pickle", "wb") as file:
                        pickle.dump(demo, file)
                    input("save 20000 steps of traj to file")
                    return
...
if __name__ == '__main__':
    ...
    for args.seed in range(0, 1):#0,10
        ...
        model, env = ppo(lambda : gym.make(args.env, renders=False), actor_critic=core.MLPActorCritic,
